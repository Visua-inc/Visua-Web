      ...
      <section className={styles.home}>
        <div className={styles.content}>
          ...
          <p className={styles.text}>
            Visua é uma aplicação para pessoas com deficiência visual, onde
            vocêpode escanear objetos ao seu redor ou escanear o código de
            barras para assim receber descrições detalhadas em áudio e em texto,
